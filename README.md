...
**[To-Do-list-React-App]** In this project user can add,edit and delete tasks and tasks are stored in the browser.
...
- [x] Create a simple To-do-list web app
- [x] Add all Your Daily tasks
- [x] Delete all your daily tasks
- [x] Edit all your daily tasks
...
- [Link](https://zunairkhan811.github.io/to-do-list-react-app/dist)
...
```sh
  git https://github.com/zunairkhan811/to-do-list-react-app.git
...
Feel free to check the [https://github.com/zunairkhan811/to-do-list-react-app.git](issue page).
